...
do
    ...
    pdftocairo -scale-to-x 960 -scale-to-y -1 -png -transp -r 300 -f 1 -l 1 "$fp" page-seg-input/${stem}
    mv page-seg-input/${stem}-1.png page-seg-input/${stem}.png

    pdftocairo -scale-to-x 960 -scale-to-y -1 -png -transp -r 300 -f 2 -l 2 "$fp" no-lines/${stem}
    mv no-lines/${stem}-2.png no-lines/${stem}.png

    pdftocairo -scale-to-x 960 -scale-to-y -1 -png -transp -r 300 -f 3 -l 3 "$fp" no-images/${stem}
